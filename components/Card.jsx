    ...
    return (
        <div className='w-72  mx-4 my-2 bg-gray-50'>
            ...
            <div className='flex px-4 w-full h-16  justify-between items-center '>
                ...
                <p className='text-base '>Rs {item?.product_price}</p>
            </div>
            <button onClick={AddToCart} className='w-full px-2 py-2 bg-blue-600 hover:bg-blue-900 transition-all duration-1000 text-white rounded'>Add to Cart</button>
        </div>
    )
}